...
| 3.   | [Прогнозирование оттока телеком компании](https://github.com/Dodukhov/Portfolio/tree/main/Churn_Prediction) | Определение потенциальных клиентов, решивших покинуть компанию, для выдачи им <br/>промокодов и других спецпредложений, <br/> минимизирующих вероятность ухода.   | Python, pandas, numpy, <br/> matplotlib, phik, sklearn, catboost. |
